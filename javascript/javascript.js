...
function displayQuestion() {
  ...
  if (selectedAnswers[currentQuestionIndex] !== null) {
    choiceButtons[selectedAnswers[currentQuestionIndex]].classList.add(
      "selected-choice"
    );
    document.getElementById("next-btn").disabled = false;
  } else {
...
(function () {
  function c() {
    ...
    if (b) {
      ...
      d.innerHTML =
        "window.__CF$cv$params={r:'97731c837277ef95',t:'MTc1NjU0NDU2OS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
